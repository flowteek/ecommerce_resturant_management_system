...
if(isset($_SESSION['uid']))
{
	...
	{
		$p_id = $r['p_id'];
		mysqli_query($con,"insert into checkout(p_id, u_id,name,mobile,email,location,mode) values('$p_id','$uid','$nm','$mo','$em','$ad','$mode')") or die("Error");
	?>
...
?>
	...
	<div style="color: #4d2e1f; font-size:1.8em;"> 
			...
			+2347016231923
<br>
			<a style="color:goldenrod; background:black; text-shadow:1px 1px 1px white;" href="menu.php">Proceed to Healthy Menu -></a>
	</div>
