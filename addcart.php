...
<body>
	...
	<form action="" method="post">
		...
		<table align="center" border="1" cellspacing="14" cellpadding="12" style="color: black" >
                ...
                <tr align="center">
                	<td colspan="4"> <input type="submit" class="btn btn-primary" name="sb" value="Add Cart Now"></td>
                </tr>
		</table>
	</form>
	<a style="color:white; font-size: 20px; border-radius:20px; text-shadow:1px 1px 19px white; background:green;" href="cart.php">Proceed to Cart Out...</a>
			<?php
			if(isset($_POST['sb']))
			{
				$pid = $_POST['pid'];
				...
				echo "<script>alert('Your data Is Add Inside Cart,Please proceed to cart')</script>";
